...
## Corpus Check
- 39 files · ~114,279 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 1 file(s) not represented in the graph (top: (none) 1)

## Summary
- 172 nodes · 134 edges · 41 communities (11 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e72ee123`
...
4. `Règles importantes` - 7 edges
5. `Guide de partage — Support de cours Zenkai` - 7 edges
...
### Community 39 - "III. Rôle des grands clans dans la naissance de Konoha"
Cohesion: 0.33
...
## Knowledge Gaps
- **114 isolated node(s):** `name`, `short_name`, `description`, `start_url`, `scope` (+109 more)
